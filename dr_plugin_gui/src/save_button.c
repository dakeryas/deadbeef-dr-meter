...
GtkWidget* add_save_button(dr_display_data_t* display_data, const char* button_label)
{
    GtkWidget* save_button = gtk_dialog_add_button(display_data->dialog, button_label, GTK_RESPONSE_NONE);
